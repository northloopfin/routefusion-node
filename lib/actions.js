...
module.exports = function (config) {
  ...
  return {
    ...
    getBeneficiariesForUser: function (userUuid) {
      return reqInstance('GET', `/users/${userUuid}/beneficiaries`);
    },
    ...
    getAllTransfersForUser: function (userUuid) {
      return reqInstance('GET', `/users/${userUuid}/transfers`);
    },
